    ...
    >
      ...
      <nav class="nav-scroll-area">
        ...
        <div class="nav-section">
          ...
          <a routerLink="/reports" routerLinkActive="active" class="nav-link" [title]="isCollapsed() ? 'Reports & Export' : ''">
            <div class="link-icon">
            ...
            <span class="link-label" *ngIf="!isCollapsed()">Reports & Export</span>
            <span class="chip chip-blue" *ngIf="!isCollapsed()">F8</span>
            <div class="active-indicator"></div>
          </a>
        </div>
      ...
      <div class="sidebar-footer">
        <div class="user-profile-row" [title]="isCollapsed() ? (authService.currentUser()?.name || 'User Profile') : ''">
          ...
          <div class="user-meta" *ngIf="!isCollapsed()">
            <span class="user-fullname">{{ authService.currentUser()?.name || 'Mohammad Ali' }}</span>
            <span class="user-jobtitle">{{ authService.currentUser()?.role || 'Principal SRE & Architect' }}</span>
          </div>

          <div class="footer-actions" *ngIf="!isCollapsed()">
            <button class="footer-btn" (click)="themeService.toggleTheme()" title="Toggle Theme" aria-label="Toggle Theme">
            ...
            <a routerLink="/settings" class="footer-btn" title="Settings" aria-label="Settings">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button class="footer-btn logout-btn" (click)="onLogout()" title="Log Out" aria-label="Log Out">
